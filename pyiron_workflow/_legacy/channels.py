...
from pyiron_workflow._legacy.mixin.has_interface_mixins import HasChannel, HasLabel
...
class Channel(
    ...
    `owner: pyiron_workflow._legacy.node.Node`.
    ...
    Attributes:
        owner (pyiron_workflow._legacy.node.Node): The channel's owner.
