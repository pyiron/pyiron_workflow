...
if TYPE_CHECKING:
    from pyiron_workflow._legacy.channels import (  # noqa: F401
    ...
    from pyiron_workflow._legacy.io import DataIO, SignalIO
    from pyiron_workflow._legacy.node import Node as WorkflowNode
...
class Node(WorkflowGraphvizMap):
    ...
    Args:
        node (pyiron_workflow._legacy.node.Node): The node to visualize.
        parent (Optional[pyiron_workflow._legacy.draw.Node]): The visualization that
    ...
    def __init__(
        ...
        if depth > 0:
            from pyiron_workflow._legacy.nodes.composite import (  # noqa: PLC0415
                Composite,
            )
