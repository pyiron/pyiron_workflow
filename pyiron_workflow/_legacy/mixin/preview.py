...
The intent is for mixing with :class:`pyiron_workflow._legacy.node.Node`, and for the inputs
...
class HasIOPreview(ABC):
    ...
    E.g. for :class:`pyiron_workflow._legacy.node.Node` that have input and output channels.
    """
