...
from pyiron_workflow._legacy.mixin.run import InterpretableAsExecutor
from pyiron_workflow._legacy.node import Node
from pyiron_workflow._legacy.nodes.composite import Composite

if TYPE_CHECKING:
    from pyiron_workflow._legacy.io import IO
...
class Workflow(Composite):
    ...
    Attribute:
        ...
        children (bidict.bidict[pyiron_workflow._legacy.node.Node]): The owned nodes that
