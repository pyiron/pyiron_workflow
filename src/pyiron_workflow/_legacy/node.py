...
from pyiron_workflow._legacy import overloading
...
from pyiron_workflow._legacy.draw import Node as GraphvizNode
from pyiron_workflow._legacy.executors.wrapped_executorlib import CacheOverride
from pyiron_workflow._legacy.io import IO, Inputs, Signals
from pyiron_workflow._legacy.logger import logger
from pyiron_workflow._legacy.mixin.display_state import HasStateDisplay
from pyiron_workflow._legacy.mixin.injection import (
    InjectsOnChannel,
    OutputDataWithInjection,
    OutputsWithInjection,
)
from pyiron_workflow._legacy.mixin.lexical import Lexical
from pyiron_workflow._legacy.mixin.run import ReadinessError, Runnable
from pyiron_workflow._legacy.storage import (
    BackendIdentifier,
    StorageInterface,
    available_backends,
)
from pyiron_workflow._legacy.topology import (
...
class Node(
    ...
    Attributes:
        ...
        parent (pyiron_workflow._legacy.composite.Composite | None): The parent object
            owning this, if any.
    ...
    def push(self, *args, **kwargs):
        ...
        :class:`pyiron_workflow._legacy.workflow.Workflow` before it has had any chance to
