...
from pyiron_workflow._legacy.create import HasCreator
from pyiron_workflow._legacy.mixin.lexical import LexicalParent
...
if TYPE_CHECKING:
    ...
    from pyiron_workflow._legacy.storage import BackendIdentifier, StorageInterface
...
class Composite(LexicalParent[Node], HasCreator, Node, ABC):
    ...
    Attributes:
        ...
        starting_nodes (None | list[pyiron_workflow._legacy.node.Node]): A subset
