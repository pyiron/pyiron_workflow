...
from pyiron_workflow._legacy.mixin.preview import ScrapesIO
from pyiron_workflow._legacy.nodes.multiple_distpatch import dispatch_output_labels
from pyiron_workflow._legacy.nodes.static_io import StaticNode
...
class Function(StaticNode, ScrapesIO, ABC):
    ...
    Examples:
        ...
        >>> from pyiron_workflow._legacy import function_node
        >>>
        >>> def mwe(x, y):
        ...     return x+1, y-1
        >>>
        ...
        >>> from pyiron_workflow._legacy import as_function_node
        >>>
...
def to_function_node(
    ...
    *output_labels,
    ...
    >>> import inspect
    >>>
    >>> from pyiron_workflow._legacy.nodes.function import to_function_node
    >>>
    ...
    {'inputs': {'node': (<class 'pyiron_workflow._legacy.node.Node'>, NOT_DATA)}, 'outputs': {'nodes_set': set[pyiron_workflow._legacy.node.Node]}}
