...
if TYPE_CHECKING:
    from pyiron_workflow._legacy.channels import Channel
...
class Macro(Composite, StaticNode, ScrapesIO, ABC):
    ...
    Examples:
        ...
        >>> from pyiron_workflow._legacy import as_macro_node, macro_node
        >>> def add_one(x):
        ...     result = x + 1
        ...     return result
        >>>
        ...
        >>> from pyiron_workflow._legacy.api import Macro
