...
from pyiron_workflow._legacy.executors.wrapped_executorlib import NodeSlurmExecutor
...
def state_check(
    wf, expected_wf, expected_n2, expected_result=pyiron_workflow._legacy.data.NOT_DATA
):
