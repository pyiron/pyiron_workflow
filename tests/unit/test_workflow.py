...
class TestWorkflow(unittest.TestCase):
    ...
    def test_io(self):
        wf = Workflow("wf")
        wf.n1 = wf.create.node_from_function(plus_one)
        wf.n2 = wf.create.node_from_function(plus_one)
        wf.n3 = wf.create.node_from_function(plus_one)
        ...
        wf.n4 = wf.create.node_from_function(plus_one)
        self.assertEqual(
    ...
    def test_io_maps(self):
        ...
        wf = Workflow("wf")
        wf.n1 = Workflow.create.node_from_function(plus_one, x=0)
        wf.n2 = Workflow.create.node_from_function(plus_one, x=wf.n1)
        wf.n3 = Workflow.create.node_from_function(plus_one, x=wf.n2)
        wf.m = Workflow.create.node_from_function(plus_one, x=42)
        wf.inputs_map = {
            "n1__x": "x",  # Rename
    ...
    def test_with_executor(self):
        ...
        wf.b = wf.create.node_from_function(plus_one, x=wf.a)
    ...
    def test_pull_and_executors(self):
        ...
        def add_three_macro(macro, one__x):
            ...
            macro.three = Workflow.create.node_from_function(plus_one, x=macro.two)
            return macro.three
    ...
    def test_storage_scopes(self):
        ...
        if "h5io" in Workflow.allowed_backends():
            with self.subTest("Instanced node"):
                wf.direct_instance = Workflow.create.node_from_function(plus_one)
                try:
                    with self.assertRaises(
                        TypeNotFoundError,
